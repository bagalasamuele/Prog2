...
/*
Esercizio 3
1.Completate il metodo String h(T v[][], T x) nella classe Ex.h 
individua gli elementi uguali ad x in un vettore di vettori generico, con elementi di tipo T, 
li trasforma in stringhe, e ne restituisce la concatenazione, rispettando l’ordine in cui gli elementi compaiono in v[][] 
(per righe e, all'interno di una riga, da sinistra a destra). Non modificate altro. Usate x.compareTo(y) per confrontare due elementi di T e supponete che x non sia null.
Usate toString() per convertire in stringa un elemento di T. 2.Fate verificare la risposta a Moodle. Non definite il vostro metodo per casi sui test.
